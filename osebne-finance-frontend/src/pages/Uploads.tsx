...
import {listUploads, uploadFile, deleteUpload, downloadUpload, type Upload} from '../lib/api';
...
export default function Uploads() {
    ...
    async function onUpload() {
        ...
        try { const res = await uploadFile(file, 'upload'); setMsg(`Naloženo: ${res.id}`); setFile(null); await load(); } catch(e:any){ setErr(e.message); }
    }
